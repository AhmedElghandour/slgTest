...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '22px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#777777'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '39px', 'lineheight' => '43px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#000000'));
			...
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '19px', 'lineheight' => '28px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#000000'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '19px', 'lineheight' => '28px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#274dc2'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '39px', 'lineheight' => '39px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '19px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '19px', 'lineheight' => '20px', 'face' => 'Lato', 'style' => 'bold', 'character'  => 'latin', 'color' => '#000000'));
		return $options;
	}
}
?>